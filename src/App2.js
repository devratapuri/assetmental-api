...
function App() {
  ...
  let assetImmutables = "assetImmutable11:S|string56, assetImmutable12:S|";
  let assetMetaImmutables =
    "traitMetaImmutable90:S|string8, traitMetaImmutable91:S|";
  ...
  let stringAssetImmutables = "string57"; // change this value if you are going to re-run mintAsset() to create a new nft
  let stringAssetMetaImmutables = "string91"; // change this value if you are going to re-run mintAsset() to create a new nft
  ...
  let generatedIdentityClassificationID =
    "devnet-mantle-1.cTtpLF3tcpnyI-VZ8deo87d__vw=";
  ...
  let identityHashID = "7ZuK-DhHf5CVcvZyPNcTx2cTiYk=";
  ...
  let generatedAssetClassificationID =
    "devnet-mantle-1.eN5lZ6bNiIWIUsCnDqho7Dj4Hqk=";
  ...
  let assetHashID = "vV-m-rtP_EPEka4JhNbnPhVp1bQ=";
